package com.mqk.netty.Netty.codec;// Generated by the protocol buffer compiler.  DO NOT EDIT!
...
public final class StudentPOJO {
  ...
  public interface StudentOrBuilder extends
    ...
    /**
     * <pre>
     *Student类中有一个属性名字为id 类型为int32(protobuf类型)对应java的int，1表示属性序号，不是值
     * </pre>
     *
  ...
  /**
   * <pre>
   *会在StudentPOJO外部类生成Student内部类。即真正发送的pojo对象
   * </pre>
   *
